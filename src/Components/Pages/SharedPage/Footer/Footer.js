        ...
        <div className="bg-primary">
            <footer className="py-3 my-4 mb-0">
                <ul className="nav justify-content-center border-bottom pb-3 mb-3">
                    <li className='nav-item'><Link className='fw-semibold mx-4 text-decoration-none text-light' to='/'>Courses</Link></li>
                ...
                <p className="text-center text-light">&copy; 2023 Company, Computer Science Academy</p>
            </footer>
        </div>
